    ...
    public class Repository : IRepository
    {
        ...
        public bool UpdLifeevent(int id, Lifeevent lifeevent)
        {
            ...
            try
            {
                ...
                {
                    this.context.Entry(existingLifeevent).CurrentValues.SetValues(lifeevent);
                    this.context.SaveChanges();
                    return true;
                }
                return false;
        ...
        public List<Lifeevent> GetLifeeventsByCelebrityId(int CelebrityId) { return this.context.Lifeevents.Where(le => le.CelebrityId == CelebrityId).ToList(); }
