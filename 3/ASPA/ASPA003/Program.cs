...
{
    FileProvider = new PhysicalFileProvider("C:\\ëàáû\\Ñìåëîâ\\ÒÏÂÈ\\TPVI-4sem\\3\\ASPA\\DAL003\\Celebrities"),
    RequestPath = new PathString("/Photo")
});

app.UseDirectoryBrowser(new DirectoryBrowserOptions
{
    FileProvider = new PhysicalFileProvider(Path.Combine("C:\\ëàáû\\Ñìåëîâ\\ÒÏÂÈ\\TPVI-4sem\\3\\ASPA\\DAL003\\Celebrities")),
