...
namespace ASPA008_1.Controllers
{
    ...
    public class CelebritiesController : Controller
    {
        ...
        private readonly string _customPhotosPath = @"C:\лабы\Смелов\ТПВИ\TPVI-4sem\8\ASPA\ASPA008_1\Photos";
        ...
        //public IActionResult ShowAddCelebrityPage()
        //{
        //    var countriesPath = Path.Combine(_env.ContentRootPath, _config.ISO3166alpha2Path);
        //    var countryCodes = CountryCodes.LoadFromFile(countriesPath);
        //    ViewData["CountriesSelectList"] = new SelectList(countryCodes, "Code", "Name");

        //    return View("AddCelebrity");
        //}
